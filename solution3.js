...
const webDevelopers = employees.filter(employee => employee.Job === 'Web Developer')
console.log(webDevelopers)

//  b.) => Return a new array with those employees that are both web developers and from Nigeria
const webDevelopersNigeria = employees.filter(employee => employee.Job === 'Web Developer' && employee.Country === 'Nigeria')
console.log(webDevelopersNigeria)

//c.) => Return a new array with those employees below 20
const underTwenty = employees.filter(employee => employee.age < 20)
console.log(underTwenty)

//d.) => Return a new array with those employees that are active
const active = employees.filter(employee => employee.active === true)
console.log(active)

// e.) => Find the highest paid developer
const maxPaidDev = employees.sort( (a, b) => {
  return a.value - b.value;
});
console.log(maxPaidDev);
